...
description: Tree Testing is an excellent tool available to help discover problems with a website or application's information architecture and improve the user experience. It can help to determine if people can find the information they're looking for on your site, and to understand if your the labels you've chosen for your navigation make sense to your users.
---
